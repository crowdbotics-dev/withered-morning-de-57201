...
## Project Structure
    ...
    ├── withered_morning_de_57201  # Django project configurations
...
1. Clone this repo and `cd withered_morning_de_57201`
...
2. Clone this repo and `cd withered_morning_de_57201`
